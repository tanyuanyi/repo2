<template>
    <div>
        ...
        <el-table :data="tableData" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="新闻类别" prop="sortname"></el-table-column>
            <el-table-column label="新闻内容" prop="content" show-overflow-tooltip></el-table-column>
        ...
        <!-- 对话框begin -->
        <el-dialog :title="ruleForm.id ? '编辑新闻' : '添加新闻'" width="90%" :visible.sync="dialogVisible" @close="close()"
            ...
            <el-form label-width="80px" ref="ruleForm" :model="ruleForm" :rules="rules">
                ...
                <el-form-item label="新闻类别" prop="sortid">
                    <el-select v-model="ruleForm.sortid" placeholder="请选择新闻类别">
                        <el-option value="" label="请选择新闻类别"></el-option>
                ...
                <el-form-item label="新闻内容" prop="content">
                    <Editor :content.sync="ruleForm.content"></Editor>
                </el-form-item>
