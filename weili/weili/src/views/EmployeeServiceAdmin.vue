<template>
    <div>
        ...
        <!-- 对话框begin -->
        <el-dialog :title="ruleForm.id ? '编辑服务' : '添加服务'" width="90%" :visible.sync="dialogVisible" @close="close()"
            ...
            <el-form label-width="80px" ref="ruleForm" :model="ruleForm" :rules="rules">
                ...
                <el-form-item label="服务类别" prop="sortid">
                    <el-select v-model="ruleForm.sortid" placeholder="请选择服务类别">
                        <el-option value="" label="请选择服务类别"></el-option>
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            axios({
                method: 'post',
                url: 'save.php?table=employeeservice',
                data: data
            }).then(res => {
        ...
        edit(id) {
            axios({
                url: 'detail.php?table=employeeservice',
                params: { id: id }
            }).then(res => {
        ...
        del(id) {
            axios({
                url: 'del.php?table=employeeservice',
                params: { id: id }
            }).then(res => {
                if (res.code == 0) {
